...
student <- read.csv("https://pos.it/r4ds-students-csv")
```
...
and then switch over to GitHub Desktop and add, commit and push this file to GitHub. Contact me if you're having trouble.
