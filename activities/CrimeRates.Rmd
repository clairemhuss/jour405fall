...
In the data, I found that the 1990s had the highest violent crime rates, and 2020 and the 2010s had some of the lowest violent rates. I expected these results because like we talked about, the crack epidemic in the 90s and possibly also gang related violence drove murder rates higher. It makes sense to me that 2020 would have the lowest rate because of COVID-related lockdown procedures and subsequent quarantining. 


When you are done, save your work, switch to GitHub Desktop, then add, command it and push your changes to GitHub and submit the URL of the notebook in ELMS.
